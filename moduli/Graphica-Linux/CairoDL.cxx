	...
	namespace Cairo
	{
		CairoAPI::CairoAPI(void)
		{
			...
			try {
				...
				DEFINE_FUNCTION_IMPORT(cairo_font_face_get_user_data)
				DEFINE_FUNCTION_IMPORT(cairo_font_face_set_user_data)
				...
				DEFINE_FUNCTION_IMPORT(cairo_scaled_font_create)
				DEFINE_FUNCTION_IMPORT(cairo_scaled_font_status)
				DEFINE_FUNCTION_IMPORT(cairo_scaled_font_destroy)
				DEFINE_FUNCTION_IMPORT(cairo_ft_scaled_font_lock_face)
				DEFINE_FUNCTION_IMPORT(cairo_ft_scaled_font_unlock_face)
				DEFINE_FUNCTION_IMPORT(cairo_set_font_face)
				DEFINE_FUNCTION_IMPORT(cairo_set_font_size)
				DEFINE_FUNCTION_IMPORT(cairo_set_scaled_font)
				DEFINE_FUNCTION_IMPORT(cairo_show_glyphs)
				DEFINE_FUNCTION_IMPORT(cairo_font_options_create)
				DEFINE_FUNCTION_IMPORT(cairo_font_options_status)
				DEFINE_FUNCTION_IMPORT(cairo_font_options_destroy)
				DEFINE_FUNCTION_IMPORT(cairo_debug_reset_static_data)
