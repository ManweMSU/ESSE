		...
		namespace Controls
		{
			namespace ArgumentService
			{
				...
				public:
					...
					{
						if (name == U"ImageNormal" && ImageNormal) {
							*value = ImageNormal;
							ImageNormal->Retain();
						} else if (name == U"ImageGrayed" && ImageGrayed) {
							*value = ImageGrayed;
							ImageGrayed->Retain();
						}
						*value = 0;
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ListBox") throw InvalidArgumentException();
			...
			string ListBox::GetControlClass(void) { return U"ListBox"; }
			...
			{
				_root.Expanded = true;
				if (Template->Properties->GetTemplateClass() != U"TreeView") throw InvalidArgumentException();
			...
			string TreeView::GetControlClass(void) { return U"TreeView"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ListView") throw InvalidArgumentException();
				...
				for (int i = 0; i < Template->Children.Length(); i++) {
					if (Template->Children[i].Properties->GetTemplateClass() == U"ListViewColumn") {
			...
			string ListView::GetControlClass(void) { return U"ListView"; }
