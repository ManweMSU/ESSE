...
namespace Engine
{
	namespace UI
	{
		...
		string Control::GetText(void) { return U""; }
		...
		string Control::GetControlClass(void) { return U"Control"; }
		...
		{
			if (FrameTemplate && FrameTemplate->Properties->GetTemplateClass() != U"DialogFrame") { Release(); throw InvalidArgumentException(); }
			...
			if (FrameTemplate) {
				...
				for (auto & child : FrameTemplate->Children) if (child.Properties->GetTemplateClass() == U"FrameExtendedData") {
		...
		void ControlSystem::ControlSystemInitializer::PostInitialize(void)
		{
			if (ExtendedData) {
				...
				if (ex_data->MacEffectBackgroundMaterial.Length()) {
					...
					if (ex_data->MacEffectBackgroundMaterial == U"Titlebar") material = Windows::CocoaEffectMaterial::Titlebar;
					else if (ex_data->MacEffectBackgroundMaterial == U"Selection") material = Windows::CocoaEffectMaterial::Selection;
					else if (ex_data->MacEffectBackgroundMaterial == U"Menu") material = Windows::CocoaEffectMaterial::Menu;
					else if (ex_data->MacEffectBackgroundMaterial == U"Popover") material = Windows::CocoaEffectMaterial::Popover;
					else if (ex_data->MacEffectBackgroundMaterial == U"Sidebar") material = Windows::CocoaEffectMaterial::Sidebar;
					else if (ex_data->MacEffectBackgroundMaterial == U"HeaderView") material = Windows::CocoaEffectMaterial::HeaderView;
					else if (ex_data->MacEffectBackgroundMaterial == U"Sheet") material = Windows::CocoaEffectMaterial::Sheet;
					else if (ex_data->MacEffectBackgroundMaterial == U"WindowBackground") material = Windows::CocoaEffectMaterial::WindowBackground;
					else if (ex_data->MacEffectBackgroundMaterial == U"HUD") material = Windows::CocoaEffectMaterial::HUD;
					else if (ex_data->MacEffectBackgroundMaterial == U"FullScreenUI") material = Windows::CocoaEffectMaterial::FullScreenUI;
					else if (ex_data->MacEffectBackgroundMaterial == U"ToolTip") material = Windows::CocoaEffectMaterial::ToolTip;
		...
		string ParentControl::GetControlClass(void) { return U"ParentControl"; }
		...
		string RootControl::GetControlClass(void) { return U"RootControl"; }
		...
		{
			// Group controls
			if (base->Properties->GetTemplateClass() == U"ControlGroup") return new Controls::ControlGroup(base, factory);
			else if (base->Properties->GetTemplateClass() == U"RadioButtonGroup") return new Controls::RadioButtonGroup(base);
			else if (base->Properties->GetTemplateClass() == U"ScrollBox") return new Controls::ScrollBox(base, factory);
			else if (base->Properties->GetTemplateClass() == U"VerticalSplitBox") return new Controls::VerticalSplitBox(base, factory);
			else if (base->Properties->GetTemplateClass() == U"HorizontalSplitBox") return new Controls::HorizontalSplitBox(base, factory);
			else if (base->Properties->GetTemplateClass() == U"BookmarkView") return new Controls::BookmarkView(base, factory);
			// Button controls
			else if (base->Properties->GetTemplateClass() == U"Button") return new Controls::Button(base);
			else if (base->Properties->GetTemplateClass() == U"CheckBox") return new Controls::CheckBox(base);
			else if (base->Properties->GetTemplateClass() == U"ToolButton") return new Controls::ToolButton(base);
			// Static controls
			else if (base->Properties->GetTemplateClass() == U"Static") return new Controls::Static(base);
			else if (base->Properties->GetTemplateClass() == U"ColorView") return new Controls::ColorView(base);
			else if (base->Properties->GetTemplateClass() == U"ProgressBar") return new Controls::ProgressBar(base);
			else if (base->Properties->GetTemplateClass() == U"ComplexView") return new Controls::ComplexView(base);
			// Scrollable controls
			else if (base->Properties->GetTemplateClass() == U"VerticalScrollBar") return new Controls::VerticalScrollBar(base);
			else if (base->Properties->GetTemplateClass() == U"HorizontalScrollBar") return new Controls::HorizontalScrollBar(base);
			else if (base->Properties->GetTemplateClass() == U"VerticalTrackBar") return new Controls::VerticalTrackBar(base);
			else if (base->Properties->GetTemplateClass() == U"HorizontalTrackBar") return new Controls::HorizontalTrackBar(base);
			// Edit controls
			else if (base->Properties->GetTemplateClass() == U"Edit") return new Controls::Edit(base);
			else if (base->Properties->GetTemplateClass() == U"MultiLineEdit") return new Controls::MultiLineEdit(base);
			else if (base->Properties->GetTemplateClass() == U"RichEdit") return new Controls::RichEdit(base);
			// List controls
			else if (base->Properties->GetTemplateClass() == U"ListBox") return new Controls::ListBox(base);
			else if (base->Properties->GetTemplateClass() == U"TreeView") return new Controls::TreeView(base);
			else if (base->Properties->GetTemplateClass() == U"ListView") return new Controls::ListView(base);
			// Combined controls
			else if (base->Properties->GetTemplateClass() == U"ComboBox") return new Controls::ComboBox(base);
			else if (base->Properties->GetTemplateClass() == U"TextComboBox") return new Controls::TextComboBox(base);
			// Menu bar control
			else if (base->Properties->GetTemplateClass() == U"MenuBar") return new Controls::MenuBar(base);
			// That's all
			else return 0;
		}
		...
		Windows::IMenu * CreateMenu(Template::ControlTemplate * base)
		{
			...
			if (base->Properties->GetTemplateClass() != U"PopupMenu" && base->Properties->GetTemplateClass() != U"MenuItem") throw InvalidArgumentException();
			SafePointer<Windows::IMenu> menu = Windows::GetWindowSystem()->CreateMenu();
			for (auto & child : base->Children) {
				if (child.Properties->GetTemplateClass() == U"MenuItem") {
				...
				} else if (child.Properties->GetTemplateClass() == U"MenuSeparator") {
					SafePointer<Windows::IMenuItem> item = Windows::GetWindowSystem()->CreateMenuItem();
