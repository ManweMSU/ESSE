...
namespace Engine
{
	namespace UI
	{
		...
		void ZeroArgumentProvider::GetArgument(const string & name, string * value) { *value = U""; }
		...
		namespace Template
		{
			...
			string BarShape::ToString(void) const { return U"Templates::BarShape"; }
			...
			string BlurEffectShape::ToString(void) const { return U"Templates::BlurEffectShape"; }
			...
			string InversionEffectShape::ToString(void) const { return U"Templates::InversionEffectShape"; }
			...
			string TextureShape::ToString(void) const { return U"Templates::TextureShape"; }
			...
			string TextShape::ToString(void) const { return U"Templates::TextShape"; }
			...
			string FrameShape::ToString(void) const { return U"Templates::FrameShape"; }
		...
		InterfaceTemplate::~InterfaceTemplate(void) {}
		string InterfaceTemplate::ToString(void) const { return U"InterfaceTemplate"; }
	}
}