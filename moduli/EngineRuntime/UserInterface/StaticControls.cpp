		...
		namespace Controls
		{
			namespace ArgumentService
			{
				...
				public:
					...
					{
						if (name == U"Progress") *value = int(Owner->Progress);
						else *value = 0;
					}
					virtual void GetArgument(const string & name, double * value) override
					{
						if (name == U"Progress") *value = Owner->Progress;
						else *value = 0.0;
					}
					virtual void GetArgument(const string & name, Color * value) override { *value = 0; }
					virtual void GetArgument(const string & name, string * value) override { *value = U""; }
				...
				public:
					...
					{
						if (name == U"Color") *value = Owner->Color;
						else *value = 0;
					}
					virtual void GetArgument(const string & name, string * value) override { *value = U""; }
					virtual void GetArgument(const string & name, Graphics::IBitmap ** value) override { *value = 0; }
				...
				public:
					...
					virtual void GetArgument(const string & name, int * value) override
					{
						if (name == U"Integer") *value = Owner->Integer;
						else if (name == U"Integer2") *value = Owner->Integer2;
						else if (name == U"Float") *value = int(Owner->Float);
						else if (name == U"Float2") *value = int(Owner->Float2);
						else *value = 0;
					}
					virtual void GetArgument(const string & name, double * value) override
					{
						if (name == U"Integer") *value = double(Owner->Integer);
						else if (name == U"Integer2") *value = double(Owner->Integer2);
						else if (name == U"Float") *value = Owner->Float;
						else if (name == U"Float2") *value = Owner->Float2;
						else *value = 0.0;
					}
					virtual void GetArgument(const string & name, Color * value) override
					{
						if (name == U"Color") *value = Owner->Color;
						else if (name == U"Color2") *value = Owner->Color2;
						else *value = 0;
					}
					virtual void GetArgument(const string & name, string * value) override
					{
						if (name == U"Text") *value = Owner->Text;
						else if (name == U"Text2") *value = Owner->Text2;
						else *value = U"";
					}
					virtual void GetArgument(const string & name, Graphics::IBitmap ** value) override
					{
						if (name == U"Image") *value = Owner->Image;
						else if (name == U"Image2") *value = Owner->Image2;
						else *value = 0;
						if (*value) (*value)->Retain();
					}
					virtual void GetArgument(const string & name, Graphics::IFont ** value) override
					{
						if (name == U"Font") *value = Owner->Font;
						else if (name == U"Font2") *value = Owner->Font2;
						else *value = 0;
						if (*value) (*value)->Retain();
					}
				};
			...
			{
				if (Template->Properties->GetTemplateClass() != U"Static") throw InvalidArgumentException();
			...
			string Static::GetControlClass(void) { return U"Static"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ProgressBar") throw InvalidArgumentException();
			...
			string ProgressBar::GetControlClass(void) { return U"ProgressBar"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ColorView") throw InvalidArgumentException();
			...
			string ColorView::GetControlClass(void) { return U"ColorView"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ComplexView") throw InvalidArgumentException();
			...
			string ComplexView::GetControlClass(void) { return U"ComplexView"; }
			...
			string ComplexView::GetText(int index) { if (index == 0) return Text; else if (index == 1) return Text2; else return U""; }
