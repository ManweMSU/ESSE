...
namespace Engine
{
	namespace UI
	{
		...
		{
			if (name == U"Text") *value = Item->GetText();
			else if (name == U"RightText") *value = Item->GetSideText();
			else *value = U"";
		}
		void MenuArgumentProvider::GetArgument(const string & name, Graphics::IBitmap ** value)
		{
			if (name == U"ImageNormal" && Base->ImageNormal) {
				*value = Base->ImageNormal;
				(*value)->Retain();
			} else if (name == U"ImageGrayed" && Base->ImageGrayed) {
				*value = Base->ImageGrayed;
				(*value)->Retain();
			} else if (name == U"CheckedImageNormal" && Base->CheckedImageNormal) {
				*value = Base->CheckedImageNormal;
				(*value)->Retain();
			} else if (name == U"CheckedImageGrayed" && Base->CheckedImageGrayed) {
		...
		public:
			...
			virtual string GetControlClass(void) override { return U"MenuList"; }
		};
		...
		public:
			...
			virtual string GetControlClass(void) override { return U"MenuHolder"; }
		};
		...
		public:
			...
			virtual string GetControlClass(void) override { return U"PopupHolder"; }
		};
