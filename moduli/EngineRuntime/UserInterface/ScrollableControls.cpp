...
namespace Engine
{
	namespace UI
	{
		namespace Controls
		{
			...
			{
				if (Template->Properties->GetTemplateClass() != U"VerticalScrollBar") throw InvalidArgumentException();
			...
			string VerticalScrollBar::GetControlClass(void) { return U"VerticalScrollBar"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"HorizontalScrollBar") throw InvalidArgumentException();
			...
			string HorizontalScrollBar::GetControlClass(void) { return U"HorizontalScrollBar"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"VerticalTrackBar") throw InvalidArgumentException();
			...
			string VerticalTrackBar::GetControlClass(void) { return U"VerticalTrackBar"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"HorizontalTrackBar") throw InvalidArgumentException();
			...
			string HorizontalTrackBar::GetControlClass(void) { return U"HorizontalTrackBar"; }
