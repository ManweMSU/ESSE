...
namespace Engine
{
	namespace UI
	{
		namespace Controls
		{
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ControlGroup") throw InvalidArgumentException();
			...
			string ControlGroup::GetControlClass(void) { return U"ControlGroup"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"RadioButtonGroup") throw InvalidArgumentException();
			...
			string RadioButtonGroup::GetControlClass(void) { return U"RadioButtonGroup"; }
			...
			string ScrollBoxVirtual::GetControlClass(void) { return U"ScrollBoxVirtual"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ScrollBox") throw InvalidArgumentException();
			...
			string ScrollBox::GetControlClass(void) { return U"ScrollBox"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"SplitBoxPart") throw InvalidArgumentException();
			...
			string SplitBoxPart::GetControlClass(void) { return U"SplitBoxPart"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"VerticalSplitBox") throw InvalidArgumentException();
			...
			string VerticalSplitBox::GetControlClass(void) { return U"VerticalSplitBox"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"HorizontalSplitBox") throw InvalidArgumentException();
			...
			string HorizontalSplitBox::GetControlClass(void) { return U"HorizontalSplitBox"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"BookmarkView") throw InvalidArgumentException();
				...
				for (int i = 0; i < Template->Children.Length(); i++) {
					...
					if (bmt.Children.Length() > 1 || bmt.Properties->GetTemplateClass() != U"Bookmark") throw InvalidArgumentException();
			...
			string BookmarkView::GetControlClass(void) { return U"BookmarkView"; }
