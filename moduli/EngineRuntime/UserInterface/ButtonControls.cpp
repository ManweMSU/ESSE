		...
		namespace Controls
		{
			namespace ArgumentService
			{
				...
				public:
					...
					{
						if (name == U"ImageNormal" && Owner->ImageNormal) {
							*value = Owner->ImageNormal;
							(*value)->Retain();
						} else if (name == U"ImageGrayed" && Owner->ImageGrayed) {
			...
			{
				if (Template->Properties->GetTemplateClass() != U"Button") throw InvalidArgumentException();
			...
			string Button::GetControlClass(void) { return U"Button"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"CheckBox") throw InvalidArgumentException();
			...
			string CheckBox::GetControlClass(void) { return U"CheckBox"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"RadioButton") throw InvalidArgumentException();
			...
			string RadioButton::GetControlClass(void) { return U"RadioButton"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ToolButton") throw InvalidArgumentException();
			...
			string ToolButton::GetControlClass(void) { return U"ToolButton"; }
			...
			{
				if (Template->Properties->GetTemplateClass() != U"ToolButtonPart") throw InvalidArgumentException();
			...
			string ToolButtonPart::GetControlClass(void) { return U"ToolButtonPart"; }
