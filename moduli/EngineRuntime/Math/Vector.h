...
namespace Engine
{
	namespace Math
	{
		...
		public:
			...
			operator string (void) const noexcept { string result = U"{"; for (int i = 0; i < D; i++) result += string(c[i]) + (i == D - 1 ? U"}" : U"; "); return result; };
		...
		public:
			...
			operator string (void) const noexcept { string result = U"{"; for (int i = 0; i < 4; i++) result += string(c[i]) + (i == 3 ? U"}" : U"; "); return result; };
			F & operator [] (int i) noexcept { return c[i]; };
			const F & operator [] (int i) const noexcept { return c[i]; };
		};
		...
		public:
			...
			operator string (void) const noexcept { string result = U"{"; for (int i = 0; i < 3; i++) result += string(c[i]) + (i == 2 ? U"}" : U"; "); return result; };
			F & operator [] (int i) noexcept { return c[i]; };
			const F & operator [] (int i) const noexcept { return c[i]; };
		};
		...
		public:
			...
			operator string (void) const noexcept { string result = U"{"; for (int i = 0; i < 2; i++) result += string(c[i]) + (i == 1 ? U"}" : U"; "); return result; };
			F & operator [] (int i) noexcept { return c[i]; };
			const F & operator [] (int i) const noexcept { return c[i]; };
		};
		...
		public:
			...
			operator string (void) const noexcept { return U"{" + string(x) + U"}"; };
			F & operator [] (int i) noexcept { return c[i]; };
			const F & operator [] (int i) const noexcept { return c[i]; };
		};
