...
namespace Engine
{
	namespace Codec
	{
		constexpr const widechar * ImageFormatDIB = U"BMP";
		constexpr const widechar * ImageFormatPNG= U"PNG";
		constexpr const widechar * ImageFormatJPEG = U"JPG";
		constexpr const widechar * ImageFormatGIF = U"GIF";
		constexpr const widechar * ImageFormatTIFF = U"TIF";
		constexpr const widechar * ImageFormatDDS = U"DDS";
		constexpr const widechar * ImageFormatHEIF = U"HEIF";
		constexpr const widechar * ImageFormatWindowsIcon = U"ICO";
		constexpr const widechar * ImageFormatWindowsCursor = U"CUR";
		constexpr const widechar * ImageFormatAppleIcon = U"ICNS";
		constexpr const widechar * ImageFormatEngine = U"EIWV";
