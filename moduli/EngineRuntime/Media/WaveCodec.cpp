...
namespace Engine
{
	namespace Audio
	{
		...
		public:
			...
			virtual string GetCodecName(void) const override { return U"Engine Waveform Codec"; }
	...
	namespace Media
	{
		...
		public:
			EngineRIFFCodec(void)
			{
				...
				riff_wav.MetadataFormatIdentifier = U"";
			}
			...
			virtual string GetCodecName(void) const override { return U"Engine RIFF Multiplexor"; }
