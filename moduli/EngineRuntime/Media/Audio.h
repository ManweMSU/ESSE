...
namespace Engine
{
	namespace Audio
	{
		constexpr const widechar * AudioFormatEngineWaveform = U"RAW";
		constexpr const widechar * AudioFormatMicrosoftWaveform = U"WAV";
		constexpr const widechar * AudioFormatMP3 = U"MP3";
		constexpr const widechar * AudioFormatAAC = U"AAC";
		constexpr const widechar * AudioFormatFreeLossless = U"FLAC";
		constexpr const widechar * AudioFormatAppleLossless = U"ALAC";
