...
namespace Engine
{
	namespace Media
	{
		constexpr const widechar * ContainerFormatMP3 = U"MP3";
		constexpr const widechar * ContainerFormatMPEG4 = U"MPEG4";
		constexpr const widechar * ContainerFormatFreeLossless = U"FLAC";
		constexpr const widechar * ContainerFormatRIFF_WAV = U"RIFF/WAV";

		constexpr const widechar * MetadataFormatID3 = U"ID3";
		constexpr const widechar * MetadataFormatiTunes = U"iTunes";
		constexpr const widechar * MetadataFormatVorbisComment = U"VC";
