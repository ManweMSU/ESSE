...
namespace Engine
{
	...
	namespace Graphics
	{
		constexpr const widechar * FontWordSerif = U"serif";
		constexpr const widechar * FontWordSans = U"sans";
		constexpr const widechar * FontWordMono = U"mono";

		constexpr const widechar * SystemSerifFont = U"@serif";
		constexpr const widechar * SystemSansSerifFont = U"@sans serif";
		constexpr const widechar * SystemMonoSerifFont = U"@mono serif";
		constexpr const widechar * SystemMonoSansSerifFont = U"@mono sans serif";
