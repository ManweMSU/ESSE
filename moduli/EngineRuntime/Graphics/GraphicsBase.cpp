...
namespace Engine
{
	namespace UI
	{
		...
		string Coordinate::ToString(void) const { return string(Absolute) + U" z " + string(Zoom) + U" w " + string(Anchor); }
		...
		string Rectangle::ToString(void) const { return U"{ " + Left.ToString() + U", " + Top.ToString() + U", " + Right.ToString() + U", " + Bottom.ToString() + U"}"; }
	}

	Point::Point(void) noexcept {}
	Point::Point(int _x, int _y) noexcept : x(_x), y(_y) {}
	string Point::ToString(void) const { return U"(" + string(x) + U", " + string(y) + U")"; }
	...
	string Box::ToString(void) const { return U"{ " + string(Left) + U", " + string(Top) + U", " + string(Right) + U", " + string(Bottom) + U"}"; }
	...
	string GradientPoint::ToString(void) const { return string(Position) + U": " + Value.ToString(); }
