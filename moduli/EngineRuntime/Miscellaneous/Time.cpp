...
namespace Engine
{
	...
	{
		return string(GetDay(), U"0123456789", 2) + U"." + string(GetMonth(), U"0123456789", 2) + U"." + string(GetYear(), U"0123456789", 4) +
			U" " + string(GetHour(), U"0123456789", 2) + U":" + string(GetMinute(), U"0123456789", 2) + U":" + string(GetSecond(), U"0123456789", 2);
	}
	string Time::ToShortString(void) const
	{
		return string(GetHour(), U"0123456789", 2) + U":" + string(GetMinute(), U"0123456789", 2) + U":" + string(GetSecond(), U"0123456789", 2);
	}
	uint64 Time::ToWindowsTime(void) const { return (Ticks - Time(1601, 1, 1, 0, 0, 0, 0).Ticks); }
	uint64 Time::ToUnixTime(void) const { return (Ticks - Time(1970, 1, 1, 0, 0, 0, 0).Ticks); }
	Time Time::FromWindowsTime(uint64 time) { return time + Time(1601, 1, 1, 0, 0, 0, 0).Ticks; }
	Time Time::FromUnixTime(uint64 time) { return time + Time(1970, 1, 1, 0, 0, 0, 0).Ticks; }
