...
namespace Engine
{
	namespace Volumes
	{
		...
		public:
			...
			virtual ImmutableString GetListType(void) const { return U"List"; }
		...
		{
		public:
			virtual ImmutableString GetListType(void) const override { return U"Queue"; }
		...
		{
		public:
			virtual ImmutableString GetListType(void) const override { return U"Stack"; }
			virtual void Push(const E & value) override { this->InsertLast(value); }
			virtual E Pop(void) override
			{
		...
		public:
			...
			virtual ImmutableString GetTreeType(void) const { return U"Binary Tree"; }
			virtual ImmutableString ToString(void) const override
			{
				DynamicString result;
				result << GetTreeType();
		...
		{
		public:
			virtual ImmutableString GetTreeType(void) const override { return U"Set"; }
		...
		public:
			...
			operator string (void) const { return GetStringRepresentation(key) + U": " + GetStringRepresentation(value); }
		};
		template<class K, class V> class Dictionary : public BinaryTree< KeyValuePair<K, V> >
		{
		public:
			virtual ImmutableString GetTreeType(void) const override { return U"Dictionary"; }
		...
		{
		public:
			virtual ImmutableString GetTreeType(void) const override { return U"Object Dictionary"; }
